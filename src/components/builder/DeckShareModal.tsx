...
export function DeckShareModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-4xl max-w-[95vw] max-h-[90vh] border-border/50 bg-background/95 backdrop-blur-xl shadow-2xl p-0 overflow-hidden flex flex-col">
        ...
        <DialogFooter className="p-6 shrink-0 bg-muted/20 border-t border-border/50 flex flex-col gap-3 sm:flex-row justify-end items-center">
